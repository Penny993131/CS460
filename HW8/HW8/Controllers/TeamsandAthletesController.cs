...
namespace HW8.Controllers
{
    public class TeamsandAthletesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,TeamID,AthleteID")] TeamsandAthlete teamsandAthlete)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,TeamID,AthleteID")] TeamsandAthlete teamsandAthlete)
        {
            if (ModelState.IsValid)
            {
